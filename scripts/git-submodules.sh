git submodule add --name buildings https://github.com/pucrs-poli/constr-sw-2022-2-g1 ./backend/buildings
git submodule add --name resources https://github.com/pucrs-poli/constr-sw-2022-2-g2 ./backend/resources
git submodule add --name reservations https://github.com/pucrs-poli/constr-sw-2022-2-g3 ./backend/reservations
